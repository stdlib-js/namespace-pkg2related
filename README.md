...
```javascript
pkg2related = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-pkg2related@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/namespace-pkg2related@v0.2.0-umd/browser.js"></script>
```
