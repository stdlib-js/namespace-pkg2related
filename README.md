...
```javascript
import pkg2related from 'https://cdn.jsdelivr.net/gh/stdlib-js/namespace-pkg2related@v0.4.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/namespace-pkg2related/actions/workflows/test.yml/badge.svg?branch=v0.4.0
[test-url]: https://github.com/stdlib-js/namespace-pkg2related/actions/workflows/test.yml?query=branch:v0.4.0
